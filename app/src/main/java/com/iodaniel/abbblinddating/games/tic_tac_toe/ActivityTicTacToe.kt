...
import com.iodaniel.abbblinddating.databinding.ActivityTicTacToeBinding
...
class ActivityTicTacToe : AppCompatActivity() {
    private val binding by lazy { ActivityTicTacToeBinding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tttBack.setOnClickListener { onBackPressed() }
        getProfileData()
        Snackbar.make(binding.root, getString(R.string.not_yet_implemented), Snackbar.LENGTH_LONG).show()
        binding.tttX.setOnClickListener {
            supportFragmentManager.beginTransaction()
                .addToBackStack("in game")
                .setCustomAnimations(R.anim.enter_right_to_left, R.anim.exit_right_to_left, R.anim.enter_left_to_right, R.anim.exit_left_to_right)
                .replace(R.id.ttt_root, FragmentTTTInGame())
                .commit()
        }
        binding.tttO.setOnClickListener {
            supportFragmentManager.beginTransaction()
                .setCustomAnimations(R.anim.enter_right_to_left, R.anim.exit_right_to_left, R.anim.enter_left_to_right, R.anim.exit_left_to_right)
                .replace(R.id.ttt_root, FragmentTTTInGame())
                .commit()
